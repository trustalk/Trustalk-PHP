...
namespace Trustalk\Rest\Api\Notifications;

use Trustalk\Util;
use Trustalk\Rest\Client;
use Trustalk\Http\CurlClient;

class Emails extends Client
{
    /**
     * メンバ変数
     * @var $client
    ...
    protected $client;
    protected $curl;
    protected $uri = '/notifications/emails';

    /**
     * Construct the Account
     * @return Trustalk\Rest\Api\Calls\Notifications\Emails
     */
